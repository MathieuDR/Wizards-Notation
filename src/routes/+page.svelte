<div>
  <label class="flex cursor-pointer gap-2">
    ...
    <input type="checkbox" value="mocha" class="toggle theme-controller" />
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
...
<div class="rounded-box px-6 py-2 w-full max-h-screen overflow-hidden">
  ...
  <div class="flex flex-col gap-3">
    ...
    <div
      class="grid grid-cols-2 place-items-center gap-2 md:grid-cols-4 lg:grid-cols-9"
    >
      <input
        type="text"
        placeholder="Default"
    ...
    <div class="flex flex-col gap-3">
      <div class="flex flex-col gap-3 md:flex-row">
        <div class="flex flex-col justify-around md:w-1/2 lg:w-1/4">
          ...
          <progress value="30" max="100" class="progress progress-neutral"
            >Neutral</progress
          >
          <progress value="40" max="100" class="progress progress-primary"
            >Primary</progress
          >
          <progress value="50" max="100" class="progress progress-secondary"
            >Secondary</progress
          >
          <progress value="60" max="100" class="progress progress-accent"
            >Accent</progress
          >
          <progress value="70" max="100" class="progress progress-info"
            >Info</progress
          >
          <progress value="80" max="100" class="progress progress-success"
            >Success</progress
          >
          <progress value="90" max="100" class="progress progress-warning"
            >Warning</progress
          >
          <progress value="100" max="100" class="progress progress-error"
            >Error</progress
          >
        </div>
        <div class="flex flex-col justify-around md:w-1/2 lg:w-1/4">
        ...
        <div
          class="flex flex-wrap items-center justify-center gap-3 md:w-1/2 lg:w-1/4"
        >
          <div class="card card-border border-base-300 w-full">
            <div class="mockup-code">
              <pre class="text-sm" data-prefix="$"><code>npm i daisyui</code
                ></pre>
              <pre class="text-sm" data-prefix=">"><code>installing...</code
                ></pre>
